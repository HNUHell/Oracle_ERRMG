* [ORA-00000 to ORA-00877](ORA-00000 to ORA-00877.md)
	* [ORA-00000: 正常的成功的完成(操作)](ORA-00000 to ORA-00877.md#ora-00000-正常的成功的完成操作)
		* [原因1: 正常执行完成。【部分验证】](ORA-00000 to ORA-00877.md#原因1-正常执行完成部分验证)
		* [原因2: hosts文件配置错误。【未验证，网络汇总】](ORA-00000 to ORA-00877.md#原因2-hosts文件配置错误未验证网络汇总)
	* [ORA-00001: 违反唯一约束条件 (string.string=>[拥有者].[约束名])](ORA-00000 to ORA-00877.md#ora-00001-违反唯一约束条件-stringstring拥有者约束名)
		* [原因1: UPDATE或INSERT语句试图插入重复的键。对于在DBMS MAC模式下配置的Trusted Oracle，如果在不同级别存在重复条目，您可能会看到此信息。【已验证】](ORA-00000 to ORA-00877.md#原因1-update或insert语句试图插入重复的键对于在dbms-mac模式下配置的trusted-oracle如果在不同级别存在重复条目您可能会看到此信息已验证)
	* [ORA-00017: 会话被要求设置跟踪事件【ora12_ERRMG】](ORA-00000 to ORA-00877.md#ora-00017-会话被要求设置跟踪事件ora12_errmg)
		* [原因1: 当前会话被要求通过另一个会话设置一个跟踪事件](ORA-00000 to ORA-00877.md#原因1-当前会话被要求通过另一个会话设置一个跟踪事件)
	* [ORA-00018: 超出最大会话数](ORA-00000 to ORA-00877.md#ora-00018-超出最大会话数)
		* [原因1: 所有会话状态对象都在使用中。【部分验证】](ORA-00000 to ORA-00877.md#原因1-所有会话状态对象都在使用中部分验证)
	* [ORA-00019: 超出最大许可会话数](#ora-00019-超出最大许可会话数)
		* [原因1: 所有许可会话都在使用中。【部分验证】](ORA-00000 to ORA-00877.md#原因1-所有许可会话都在使用中部分验证)
	* [ORA-00020: 超出最大进程数(string=>[最大进程数])](ORA-00000 to ORA-00877.md#ora-00020-超出最大进程数string最大进程数)
		* [原因1: 所有进程状态对象都在使用中。【部分验证】](ORA-00000 to ORA-00877.md#原因1-所有进程状态对象都在使用中部分验证)
